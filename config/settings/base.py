...
MIGRATION_MODULES = {"sites": "hesma.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "hesma.users.context_processors.allauth_settings",
            ],
            "libraries": {
                "auth_extras": "hesma.templatetags.auth_extras",
            },
        },
    }
]
...
ADMINS = [("""Alexander Holas""", "alexander.holas@h-its.org")]
...
ACCOUNT_FORMS = {"signup": "hesma.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "hesma.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "hesma.users.forms.UserSocialSignupForm"}
